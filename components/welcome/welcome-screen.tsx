      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <h1 className="text-4xl font-bold tracking-tight">lookate</h1>
          </div>
        ...
        <Card className="max-w-4xl mx-auto">
          <CardHeader>
            <CardTitle className="text-center">Live Map Preview</CardTitle>
            ...
            <div className="relative h-64 bg-gradient-to-br from-blue-100 to-green-100 dark:from-blue-900 dark:to-green-900 rounded-lg overflow-hidden">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground">Interactive map with live user markers</p>
                </div>
              </div>
